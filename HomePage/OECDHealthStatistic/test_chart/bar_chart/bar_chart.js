...
slider.addEventListener('click', function(event) {
    ...
    get_data_from_year(year).then(function(data) {
        ...
        // var update = true;
        // updateChart(dataset, year);
        drawchart(dataset);
    });
    });

function get_data_from_year(year) {
    console.log("THIS IS TABLE YEAR "+year);
    return d3.csv("../../Processed_Data/Life_expectancy.csv").then(function(data) {
    // return d3.csv("../Processed_Data/GDP_processed.csv").then(function(data) {
...
get_data_from_year(2022).then(function(data) {
    var dataset = [];
