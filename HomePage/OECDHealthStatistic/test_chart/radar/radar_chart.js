...
// const data = d3.csv("../../Processed_Data/Health_workforce.csv");
...
//         return d.Year === '2020' && d.Country_code === 'AUS';
//     });
//     // console.log(data_in_cou_year);
...
//     var svg = d3.selectAll('#radar-chart')
//                 .append('svg')
//                 .attr("width",  cfg.w + cfg.margin.left + cfg.margin.right)
//                 .attr("height", cfg.h + cfg.margin.top + cfg.margin.bottom)
//                 // .attr("class", "radar"+ 'radar_chart');
//                 .attr("class", "radar");
...
// });
    ...
    const dataPromise = d3.csv("../../Processed_Data/Health_workforce.csv");
    ...
    Promise.all([dataPromise]).then(function (values) {
        ...
        var maxValue = d3.max(transformedData, function (d) { return d.value; });
