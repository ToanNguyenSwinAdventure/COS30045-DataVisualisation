...
function choropleth(){
    ...
    // var legend = d3.select("#choropleth")
    //     .append("g")
    ...
    slider.addEventListener('click', function(event) {
        ...
        get_data_from_year(year).then(function(data) {
            ...
            //         .duration(200)
            //         .style("opacity", .9);
            //     tooltip.html("Country: " + d.properties.name + "<br/>Value: " + d.properties.value)
    ...
    // var data = d3.csv("../Processed_Data/GDP_processed.csv").then(function(data) {
    var data = d3.csv("../Processed_Data/Life_expectancy.csv").then(function(data) {
        // console.log(data)
        data_in_year = [];
    ...
    function get_data_from_year(year) {
        return d3.csv("../Processed_Data/Life_expectancy.csv").then(function(data) {
    ...
    //Title
        ...
        .text("Life Expectancy of World Countries");
