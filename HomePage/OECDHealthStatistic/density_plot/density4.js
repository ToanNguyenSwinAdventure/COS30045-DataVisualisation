...
function createDensityOption() {
    ...
    densityOptionDiv.append("h3")
        .html('Life Expectancy Density For <span id="country"></span> in <span id="leYear">2021</span>');
}

// Call the function to create the density option section




// function createDensityOptions(containerId) {
//     // Create the main div element
//     const densityOptionDiv = document.createElement("div");
//     densityOptionDiv.setAttribute("id", "density-option");

//     // Create label for Data Type
//     const dataTypeLabel = document.createElement("label");
//     dataTypeLabel.setAttribute("for", "dataType");
//     dataTypeLabel.textContent = "Select Data Type: ";

//     // Create select element for Data Type
//     const dataTypeSelect = document.createElement("select");
//     dataTypeSelect.setAttribute("id", "dataType");

//     // Data Type options
//     const dataTypeOptions = [
//         { value: "Value", text: "Life Expectancy" },
//         { value: "GDP", text: "GDP" },
...
//     // Create h3 element for displaying information
//     const infoHeader = document.createElement("h3");
//     infoHeader.innerHTML = 'Life Expectancy Density For <span id="country"></span> in <span id="leYear">2021</span>';

//     // Append elements to the main div
//     densityOptionDiv.appendChild(dataTypeLabel);
//     densityOptionDiv.appendChild(dataTypeSelect);
//     densityOptionDiv.appendChild(infoHeader);

//     // Append the main div to the specified container
//     const container = document.getElementById(containerId);
//     container.appendChild(densityOptionDiv);
// }

// Usage
// window.onload = function() {
//     createDensityOptions("densityOptionsContainer"); // Assuming there is a container with id="densityOptionsContainer"
// };
