function scatter_plot(){
    ...
    function get_data_from_year(year){
        return Promise.all([
            ...
            d3.csv("../Processed_Data/country_continent.csv"),
            d3.csv("../Processed_Data/Population.csv"),
            d3.csv("../Processed_Data/Health_expenditure.csv"),
    ...
    function handleMouseOver(event, d) {
        ...
        var tooltipContent = d.lifeExpectancy && d.gdp_capita ? 
            ...
            <strong>Health Expenditure per Capita:</strong> ${d.health_expenditure_capita} $US<br> 
